  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center px-6 py-4 shadow-md mx-auto w-full max-w-6xl bg-white rounded-xl mt-6 dark:bg-gray-900 transition-all">
        <span className="text-2xl font-bold text-blue-600 dark:text-white">Paymt</span>
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        <div className="mb-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-blue-50 p-4 rounded-xl shadow-sm dark:bg-gray-800">
            <h2 className="text-lg font-semibold text-gray-700 dark:text-gray-200 mb-2">Your Balance</h2>
            <p className="text-2xl font-bold text-blue-600 dark:text-white">₹ {balance}</p>
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1">Search Users</label>
